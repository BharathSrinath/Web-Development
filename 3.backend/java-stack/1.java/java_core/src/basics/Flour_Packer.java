...
public class Flour_Packer {
	...
	public static void main(String[] args) {
        ...
        int bigCount = input.nextInt();
        System.out.print("\nEnter a smallCount: ");
        int smallCount = input.nextInt();
        System.out.print("\nEnter your goal: ");
        ...
        if (bigCount < 0 || smallCount < 0 || goal < 0) {
        	System.out.print("Cannot be packed!");
        }
        ...
        } else if (smallCount >= goal - (bigCount * 5)) {
            	System.out.print("Can be packed!");
            }
	}
...
//
//1. canPack (1, 0, 4); should return false since bigCount is 1 (big bag of 5 kilos) and goal is 4 kilos.
//2. canPack (1, 0, 5); should return true since bigCount is 1 (big bag of 5 kilos) and goal is 5 kilos.
//3. canPack (0, 5, 4); should return true since smallCount is 5 (small bags of 1 kilo) and goal is 4 kilos, and we have 1 bag left which is ok as mentioned above.
//4. canPack (2, 2, 11); should return true since bigCount is 2 (big bags 5 kilos each) and smallCount is 2 (small bags of 1 kilo), makes in total 12 kilos and goal is 11 kilos. 
//5. canPack (-3, 2, 12); should return false since bigCount is negative.