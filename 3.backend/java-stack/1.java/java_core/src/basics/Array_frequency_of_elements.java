...
// Even when you have values that are same in your array, they are not considered as the same element. 
...
// So when the question is about element, you have to write the code to find from a[0] to a[n]
// irrespective of their values being same.
//	To achieve this, 
