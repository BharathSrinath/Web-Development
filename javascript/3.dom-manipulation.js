...
// Before getting into it, you have to understand this. You already know the difference between node and element. So while you append using 'appendChild' you are appending to the nodes and not to the elements. But when you use 'append', then you are appending to the element.
    // So while using appendChild you should select its parents with selector and store their objectEvents in a variable. Now you can append using this variable (parent)

// 1. Appending using 'appendChild'
