...
// 3. Number of columns doesn't have to match number of properties in an object 
  // That is some objects can have 5 properties and some can have just 4
// 4. Deriving a cells value based on other cells
// 5. Making ceks display arbitrary values 
