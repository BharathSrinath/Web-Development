...
function App() {
  ...
  return (
    <div>
      ...
      <ShoppingList items={[
        { id: 1, item: "eggs", quantiy: 12, completed: false },
        { id: 2, item: "milk", quantiy: 2, completed: true },
        { id: 3, item: "chicken", quantiy: 4, completed: false },
        { id: 4, item: "carrot", quantiy: 6, completed: true }
      ]} />
      <Property items={[
      ...
      <div className='Profilecard'>
        ...
        {/* New understanding with props: react collects all the attributes and make it as a single object. Name of that object will be the name of the argument that you specify ta the child component. So you access these attributes with in the function just like you access an object in general using method(.) operator. */}
        {/* Or you can destructure an object as you have been doing it for the last few exercises where instead of using oject name and the method operator, you can directly n number names inside {} for n number of attributes.  */}
        {/* Destructuring involves extracting values from objects or arrays and assigning them to variables.  */}
      </div>
      {/* Creating a project in which random animals will be displayed (from an array list) with a buttton click. The animal will have an heart symbol at the bottom conrer that will increase in size when you click the div element under which the animal is placed. */}
      <AnimalProject />
      {/* Colorbox Project */}
