...
export default function DoubleDice() {
  ...
  return (
    <div style={styles}>
      ...
      {/* You know how the && works right? If you the first condition, second condition will not even be checked. We are doing this to avoid adding empty h3 element when we loose the game.*/}
      <p>Num1: {num1}</p>
      <p>Num2: {num2}</p>
    </div>
  );
