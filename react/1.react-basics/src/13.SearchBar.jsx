...
// Terms like onSubmit, onChange are just strings that are referring to a function as defined by us.
    // But when they are used along with HTML elements, they act as eventHandlers. For an example, onSubmit used in the App.jsx is just a string referring to a function. But the onSubmit used within the form element is an eventHandler. There is no such thing as 'onChange' eventHandler in JS. We are just using that as a string referring to a function
