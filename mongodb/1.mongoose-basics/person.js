...
// Mongoose virtuals
// The purpose of using virtuals in Mongoose is to have more control over the data that we don't want to persist in the MongoDB database. 
...
// The get method of a virtual property can set the value of the virtual property from existing document field values, and it returns the virtual property value14. Mongoose calls the get method every time you access the virtual property.
// The set method of a virtual property can set the value of existing document fields from the value of the virtual property. (exactly opposite to set)


// Middlware in mongoose
...
personSchema.pre('save', function(next) {
    ...
    next();
    // next() is a function that passes control to the next middleware function12. If the current middleware function does not end the request-response cycle, it must call next() to pass control to the next middleware function123. Otherwise, the request will be left hanging.
});
