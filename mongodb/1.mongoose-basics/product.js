...
// In index.js we saw how schema works. But there is more to it. When we specify name: string, it inherently means that type is string. But apart from type there are many properties as show below. And as always you can nest properties. You can add a new property while creating a model instance. It won'y break the code but at the same time it wont be added to the database too.
const productSchema = new mongoose.Schema({
    ...
    size: {
        type: String,
        enum: ['S', 'M', 'L']
        // enum checks of the entered value is in this array list
    }
