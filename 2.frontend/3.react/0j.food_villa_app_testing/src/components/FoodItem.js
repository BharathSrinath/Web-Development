const FoodItem = ({
  ...
  return (
    <div className="w-52 p-2 m-2 shadow-lg bg-green-100">
      ...
      <img className="w-48 h-48 m-auto" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" + imageId} />
      <h3 className="font-bold text-xl">{name}</h3>
      <h5>{description}</h5>
      <h5>Rupees: {defaultPrice/100}</h5>
      <span>
        <h4>{avgRating}</h4>
      </span>
    </div>
