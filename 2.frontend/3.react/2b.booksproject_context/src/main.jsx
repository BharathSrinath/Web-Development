...
root.render(
  <Provider>
    <App />
    {/* main.jsx is the first file to be executed. What happens in this line of code is that the provider component is executed (it's not executed in the traditional sense like a function call. Instead, it's being used as a React component) and App component is passed as a prop to the provider component. */}
  </Provider>
);

// 1. Create a file and define all the functions which are needed by multiple child components (books.jsx)
// 2. Declare a variable (BooksContext) and assign createContext() hook.
