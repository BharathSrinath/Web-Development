...
// These are all part where out content changes based on users input. But when you look carefully, the last 2 doesn't change directly based on user's input. Rather they based on based on first 4. Hence total cost and matched cars are called as derived state.
...
// Redux Store design
  ...
  // 3. Group together common pieces of state - Very much subjective
    // Possibility 1
      // a) state related adding cars - name, cost
