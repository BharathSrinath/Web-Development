...
// Then, we want the user to navigate to specific route for which we need to access to navigate().
// If we want to include any links in future that should be redirected to some other web page with differentt domain name, we will not placeit here.
