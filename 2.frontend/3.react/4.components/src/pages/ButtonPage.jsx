    ...
    <div>
      <div>
        <Button primary outline rounded margin ="m-5" onClick={handleClick}>
          {/* Here Button is a component not an HTML element */}
          {/* You know it. But just a reminder. Also when there is no assignment operator and value, by default they take a boolean value of 'true' */}
          <GoBell />
          Click me!!
        </Button>
      </div>
